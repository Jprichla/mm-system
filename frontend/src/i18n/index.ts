...
const resources = {
  pt: {
    translation: {
      ...
      visualizarComo: 'Visualizar como',
      modoVisualizacaoAtivo: 'Modo de visualização: {{role}}.',
      contaContinuaAdmin: 'Sua conta continua sendo Admin.',
      voltarAoAdmin: 'Voltar ao Admin',
      roleAdmin: 'Admin',
      roleGestor: 'Gestor',
      roleEngenheiro: 'Engenheiro',
      roleUsuario: 'Usuário',
      roleCliente: 'Cliente',
  ...
  en: {
    translation: {
      ...
      role_usuario: 'User',
      role_cliente: 'Client',
      visualizarComo: 'View as',
      modoVisualizacaoAtivo: 'Preview mode: {{role}}.',
      contaContinuaAdmin: 'Your account remains Admin.',
      voltarAoAdmin: 'Return to Admin',
      roleAdmin: 'Admin',
      roleGestor: 'Manager',
      roleEngenheiro: 'Engineer',
      roleUsuario: 'User',
      roleCliente: 'Client',
  ...
  es: {
    translation: {
      ...
      tema: 'Tema',
      idioma: 'Idioma',
      abrirNavegacao: 'Abrir navegación',
      fecharNavegacao: 'Cerrar navegación',
      fecharDialogo: 'Cerrar {{titulo}}',
      claro: 'Claro',
      escuro: 'Oscuro',
      ...
      role_cliente: 'Cliente',
      visualizarComo: 'Ver como',
      modoVisualizacaoAtivo: 'Modo de vista: {{role}}.',
      contaContinuaAdmin: 'Tu cuenta sigue siendo Admin.',
      voltarAoAdmin: 'Volver a Admin',
      roleAdmin: 'Administrador',
      roleGestor: 'Gestor',
      roleEngenheiro: 'Ingeniero',
      roleUsuario: 'Usuario',
      roleCliente: 'Cliente',
